...
static struct argp_option options[] = {
    {"device_id", 'i', "VALUE", 0, "Specify Tuya device id"},
    {"device_secret", 's', "VALUE", 0, "Specify Tuya device secret"},
    {"product_id", 'p', "VALUE", 0, "Specify Tuya product id"},
    {"daemonize", 'D', 0, OPTION_ARG_OPTIONAL,
     "Launch the program as a daemon"},
    {0}};
